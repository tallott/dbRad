CREATE TABLE [metadata].[ApplicationFilter] (
    ...
    CONSTRAINT [FK_ApplicationFilter_ApplicationTable] FOREIGN KEY ([ApplicationTableId]) REFERENCES [metadata].[ApplicationTable] ([ApplicationTableId])
);
